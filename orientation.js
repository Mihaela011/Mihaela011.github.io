document.getElementById("id_logic_version").innerHTML = "Logic version: 2018.11.05.4";
...
function on_device_motion(e)
{
	...
	document.getElementById("id_acc_y").innerHTML =Math.round(acc_y*100)/100;
     ...
     document.getElementById("id_rot_x").innerHTML =Math.round(Math.atan(acc_y/acc_z)*180)/Math.PI*100)/100;
